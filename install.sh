#!/usr/bin/env bash
# ╔══════════════════════════════════════════════════════════════╗
# ║  NimOS Beta 8.1 Installer                                  ║
# ║  Transforms Ubuntu/Debian Server into a NimOS NAS          ║
# ║  curl -fsSL https://raw.githubusercontent.com/               ║
# ║    andresgv-beep/NimOs-beta-8.1/main/install.sh | sudo bash║
# ╚══════════════════════════════════════════════════════════════╝

set -euo pipefail

# ── Config ──
NIMOS_VERSION="8.1.0-alpha"
NIMOS_REPO="https://github.com/andresgv-beep/NimOs-beta-8.1"
NIMOS_BRANCH="main"
...
install_nimos() {
  ...
  TARBALL_URL="https://github.com/andresgv-beep/NimOs-beta-8.1/archive/refs/heads/${NIMOS_BRANCH}.tar.gz"
